...
class Primitives:
    ...
    def plot(self, theta: float = 0, all_headings=False):
        ...
        fig, ax = plt.subplots(1, self.num_headings // 4, figsize=(10, 10), sharex=True, sharey=False)
...
if __name__ == '__main__':
    ...
    p = Primitives(scale=15, turning_radius=2, num_headings=8, step_size=0.5, cache=False)
